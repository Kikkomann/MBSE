...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Split Transition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dk.dtu.compute.mbse.yawl.impl.SplitTransitionImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SplitTransitionImpl extends AttributeImpl implements SplitTransition {
	/**
	...
	protected EClass eStaticClass() {
		return YawlPackage.Literals.SPLIT_TRANSITION;
	}
	...
	public void setText(TType newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YawlPackage.SPLIT_TRANSITION__TEXT, oldText, text));
	}
