...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Join Transition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dk.dtu.compute.mbse.yawl.impl.JoinTransitionImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinTransitionImpl extends AttributeImpl implements JoinTransition {
	/**
	...
	protected EClass eStaticClass() {
		return YawlPackage.Literals.JOIN_TRANSITION;
	}
	...
	public void setText(TType newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YawlPackage.JOIN_TRANSITION__TEXT, oldText, text));
	}
