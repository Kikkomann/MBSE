 ...
 * </p>
 * <ul>
 *   <li>{@link yawl.yawlannotations.impl.SelectArcsImpl#getTargetTransition <em>Target Transition</em>}</li>
 *   <li>{@link yawl.yawlannotations.impl.SelectArcsImpl#getSourceTransition <em>Source Transition</em>}</li>
 *   <li>{@link yawl.yawlannotations.impl.SelectArcsImpl#getSourceMarking <em>Source Marking</em>}</li>
 *   <li>{@link yawl.yawlannotations.impl.SelectArcsImpl#isSelected <em>Selected</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectArcsImpl extends ObjectAnnotationImpl implements SelectArcs {
	 ...
	 * @ordered
	 */
	protected EList<EnabledTransitions> targetTransition;
	 ...
	 * @generated
	 */
	public EList<EnabledTransitions> getTargetTransition() {
		if (targetTransition == null) {
			targetTransition = new EObjectWithInverseResolvingEList<EnabledTransitions>(EnabledTransitions.class, this, YawlannotationsPackage.SELECT_ARCS__TARGET_TRANSITION, YawlannotationsPackage.ENABLED_TRANSITIONS__IN_ARC);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case YawlannotationsPackage.SELECT_ARCS__TARGET_TRANSITION:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTargetTransition()).basicAdd(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case YawlannotationsPackage.SELECT_ARCS__TARGET_TRANSITION:
				...
				getTargetTransition().addAll((Collection<? extends EnabledTransitions>)newValue);
				return;
			case YawlannotationsPackage.SELECT_ARCS__SOURCE_TRANSITION:
