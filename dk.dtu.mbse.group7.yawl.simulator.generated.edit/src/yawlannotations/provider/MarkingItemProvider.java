/**
 */
package yawlannotations.provider;
...
/**
 * This is the item provider adapter for a {@link yawlannotations.Marking} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MarkingItemProvider extends ObjectAnnotationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Marking_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Marking_value_feature", "_UI_Marking_type"),
				 YawlannotationsPackage.Literals.MARKING__VALUE,
				 true,
				 false,
				 false,
